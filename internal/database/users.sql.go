...
SELECT id, email, created_at, updated_at, hashed_password FROM users WHERE users.email = $1
`
...
SELECT id, email, created_at, updated_at, hashed_password FROM users WHERE users.id = $1
`
